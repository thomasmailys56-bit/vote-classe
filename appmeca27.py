...
def get_url(sheet_name):
    # Cette URL force Google à donner les données proprement
...
try:
    ...
    # ON CRÉE LA LISTE ICI POUR QU'ELLE SOIT DISPONIBLE PARTOUT
    ...
    st.info("Vérifie que tes onglets s'appellent exactement 'Utilisateurs' et 'Votes'")
    st.stop()
...
if 'user' not in st.session_state:
    ...
    if not deja_vote:
        ...
        # On utilise la liste définie tout en haut
